...
Route::get('/check-mobile', [FrontendEventController::class, 'checkMobile'])->name('checkMobile');
Route::post('/event-registration', [FrontendEventController::class, 'register'])->name('eventRegistration');
Route::get('/event-registrations/{eventId}', [FrontendEventController::class, 'viewRegistrations'])->name('viewEventRegistrations');
